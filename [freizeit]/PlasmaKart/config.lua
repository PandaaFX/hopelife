...
MaskFemme = {
[1]={model = 102, colorA = 0, colorB = 3},
--[2]={model = 108, colorA = 0, colorB = 1}
}

MaskHomme = {
[1]={model = 49, colorA = 0, colorB = 3},
--[2]={model = 108, colorA = 0, colorB = 1}
}
...
--Basic server
TenuFemme = { 
[3] = {model = 0}, 		-- Torso / Arms / Bras
[4] = {model = 139, color = 1}, 	-- Legs / Pants / Jambe
[6] = {model = 19, color = 1}, 	-- Feet / Shoes / Chaussure

[7] = {model = -1}, 		--Accessories / Accessoires
[8] = {model = -1}, 		--Undershirt / T-Shirt
[11] = {model = 290, color = 0}, 	--Tops / Veste
}

TenuHomme = {
[3] = {model = 0},		-- Torso / Arms / Bras
[4] = {model = 137, color = 3},    -- Legs / Pants / Jambe
[6] = {model = 28, color = 4},     -- Feet / Shoes / Chaussure
                                                
[7] = {model = -1},      --Accessories / Accessoires
[8] = {model = -1},     --Undershirt / T-Shirt
[11] = {model = 633, color = 0},   --Tops / Veste
}
