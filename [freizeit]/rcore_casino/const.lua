...
stringValues = {{"SLOTS_RT_BET", "Wette"}, {"SLOTS_RT_LSTWIN", "Letzter Sieg"}, {"SLOTS_MESN101", "Kotze mich aus!"},
                {"SLOTS_MESP101", "Genial!"}, {"SLOTS_MESN102", "Nicht mal!"}, {"SLOTS_MESP102", "Röhrenförmig"},
                {"SLOTS_MESN103", "GEIL!"}, {"SLOTS_MESP103", "Wow!"}, {"SLOTS_MESN104", "Nice"},
                {"SLOTS_MESP104", "Fantastisch!"}, {"SLOTS_MESN105", "Oh. Mein. Gott."}, {"SLOTS_MESP105", "Groovig"},
                {"SLOTS_MESN106", "Beruhig dich"}, {"SLOTS_MESP106", "Radikal!"}, {"SLOTS_MESN107", "So lahm!"},
                {"SLOTS_MESP107", "Gerecht!"}, {"SLOTS_MESN108", "loser"}, {"SLOTS_MESP108", "Wie Geil!"},
                {"SLOTS_MESN109", "sparrow"}, {"SLOTS_MESP109", "Clutch!"}, {"SLOTS_MESN110", "Du stolperst'"},
                {"SLOTS_MESP110", "Tränen!"}, {"SLOTS_MESN111", "hart"}, {"SLOTS_MESP111", "Krank!"},
                {"SLOTS_MESN112", "Knebel mich!"}, {"SLOTS_MESP112", "Eng"}, {"SLOTS_MESN113", "Spaßverderber"},
                {"SLOTS_MESP113", "Schlampig'!"}, {"SLOTS_MESN114", "falsch!"}, {"SLOTS_MESP114", "Total strange!"},
                {"SLOTS_MESN115", "Major Kill!"}, {"SLOTS_MESP115", "Whoa!"}, {"SLOTS_MESN116", "Auslöschen!"},
                {"SLOTS_MESP116", "Sweet!"}, {"SLOTS_MESN201", "Trigger Warnung!"}, {"SLOTS_MESP201", "Du kannst es schaffen!"},
                {"SLOTS_MESN202", "Nicht fair!"}, {"SLOTS_MESP202", "Tief einatmen!"}, {"SLOTS_MESN203", "Schmollmund!"},
                {"SLOTS_MESP203", "Mach weiter!"}, {"SLOTS_MESN204", "Konservative saugen!"},
                {"SLOTS_MESP204", "Bleib positiv!"}, {"SLOTS_MESN205", "Beschuldigen Sie die Konservativen!"},
                {"SLOTS_MESP205", "Du bist ein guter Mensch"}, {"SLOTS_MESN206", "Rufen Sie Ihren Therapeuten an"},
                {"SLOTS_MESP206", "Sie befinden sich in einem sicheren Bereich"}, {"SLOTS_MESN207", "Unterdrückt fühlen?"},
                {"SLOTS_MESP207", "Tugendsignal!"}, {"SLOTS_MESN208", "Getrollt!"},
                {"SLOTS_MESP208", "Du bist keine Schneeflocke!"}, {"SLOTS_MESN209", "Überprüfen Sie Ihr Privileg"},
                {"SLOTS_MESP209", "Mach Yoga!"}, {"SLOTS_MESN210", "Öffentliches Radio unterstützen"},
                {"SLOTS_MESP210", "Meditiere mehr!"}, {"SLOTS_MESN211", "Du bist nicht aufgewacht!"},
                {"SLOTS_MESP211", "Sie machen einen Unterschied!"}, {"SLOTS_MESN212", "Seien Sie sich Ihrer Vorurteile bewusst!"},
                {"SLOTS_MESP212", "Recyceln!"}, {"SLOTS_MESN213", "Sei kein Troll!"},
                {"SLOTS_MESP213", "Du bist kostbar!"}, {"SLOTS_MESN214", "Aufgewacht!"}, {"SLOTS_MESP214", "Aufklärung!"},
                {"SLOTS_MESN215", "Tief einatmen"}, {"SLOTS_MESP215", "Achtsamkeit!"}, {"SLOTS_MESN216", "Abstimmen!"},
                {"SLOTS_MESP216", "Erkenne das Privileg an!"}, {"SLOTS_MESN301", "Autsch!"},
                {"SLOTS_MESP301", "Sichern und Laden!"}, {"SLOTS_MESN302", "Das ist nicht gut!"},
                {"SLOTS_MESP302", "Einmal abschießen"}, {"SLOTS_MESN303", "Was zur Hölle?"}, {"SLOTS_MESP303", "Bekommen!"},
                {"SLOTS_MESN304", "Tot wie die Hölle!"}, {"SLOTS_MESP304", "Mission erfüllt!"},
                {"SLOTS_MESN305", "Gut werde ich sein!"}, {"SLOTS_MESP305", "Du bist ein Patriot!"},
                {"SLOTS_MESN306", "Versuchst du es überhaupt?"}, {"SLOTS_MESP306", "Vogel!"}, {"SLOTS_MESN307", "Scheiße!"},
                {"SLOTS_MESP307", "Ohhh Jaa!"}, {"SLOTS_MESN308", "Verwirrung!"}, {"SLOTS_MESP308", "Lass uns das machen!"},
                {"SLOTS_MESN309", "Verdammter"}, {"SLOTS_MESP309", "Habt ihr Spaß?"}, {"SLOTS_MESN310", "Wirklich schlecht"},
                {"SLOTS_MESP310", "Sei ein Held!"}, {"SLOTS_MESN311", "Andere Beschuldigen"}, {"SLOTS_MESP311", "Oorah!"},
                {"SLOTS_MESN312", "Verdammter Bullshit!"}, {"SLOTS_MESP312", "Ziel erreicht!"},
                {"SLOTS_MESN313", "Cluster"}, {"SLOTS_MESP313", "Nuke aus dem Orbit!"},
                {"SLOTS_MESN314", "FUBAR!"}, {"SLOTS_MESP314", "Alien BBQ!"}, {"SLOTS_MESN315", "Ein Mann weniger!"},
                {"SLOTS_MESP315", "Freiheiten geschützt!"}, {"SLOTS_MESN316", "AUFLEUCHTEN!"}, {"SLOTS_MESP316", "Verdammter"},
                {"SLOTS_MESN401", "Schande"}, {"SLOTS_MESP401", "Berühmt!"}, {"SLOTS_MESN402", "Peinlich!"},
                {"SLOTS_MESP402", "Fame!"}, {"SLOTS_MESN403", "Abscheulich!"}, {"SLOTS_MESP403", "Du kannst es schaffen!"},
                {"SLOTS_MESN404", "Wie schrecklich!"}, {"SLOTS_MESP404", "Du bist so talentiert"},
                {"SLOTS_MESN405", "Abgestimmt!"}, {"SLOTS_MESP405", "Du bist ein Star"}, {"SLOTS_MESN406", "So leid!"},
                {"SLOTS_MESP406", "Sei unglaublich!"}, {"SLOTS_MESN407", "Das ist ein Fail!"}, {"SLOTS_MESP407", "Tu es!"},
                {"SLOTS_MESN408", "Nun, das war scheiße!"}, {"SLOTS_MESP408", "Du bist die Nummer eins!"},
                {"SLOTS_MESN409", "Kein Talent!"}, {"SLOTS_MESP409", "Du schaffst das!"},
                {"SLOTS_MESN410", "Bist du das Pablo?"}, {"SLOTS_MESP410", "Du bist der beste!"},
                {"SLOTS_MESN411", "Selbstmord Watch!"}, {"SLOTS_MESP411", "Du bist die Nummer 1"},
                {"SLOTS_MESN412", "Von Sponsoren gedroppt"}, {"SLOTS_MESP412", "Sei unaufhaltsam!"},
                {"SLOTS_MESN413", "Karriere BEENDET!"}, {"SLOTS_MESP413", "Erschreckend talentiert!"},
                {"SLOTS_MESN414", "Auf den Kopf gestellt!"}, {"SLOTS_MESP414", "Du brennst!"}, {"SLOTS_MESN415", "Boooo!"},
                {"SLOTS_MESP415", "So Hawt!"}, {"SLOTS_MESN416", "Was für eine Katastrophe!"},
                {"SLOTS_MESP416", "Amerikas Liebling!"}, {"SLOTS_MESN501", "Du wurdest verflucht!"},
                {"SLOTS_MESP501", "Sie wurden gesegnet!"}, {"SLOTS_MESN502", "Die Götter sind wütend!"},
                {"SLOTS_MESP502", "Der Pharao ist zufrieden!"}, {"SLOTS_MESN503", "Du hast die Götter verärgert!"},
                {"SLOTS_MESP503", "Sonnen Sie sich im Schein!"}, {"SLOTS_MESN504", "Ruiniert!"},
                {"SLOTS_MESP504", "Ruhm erwartet!"}, {"SLOTS_MESN505", "Hoffnung verfinstert!"},
                {"SLOTS_MESP505", "Die Götter freuen sich!"}, {"SLOTS_MESN506", "Königreich ruiniert"},
                {"SLOTS_MESP506", "Die Sphinx wartet!"}, {"SLOTS_MESN507", "Dynastie in Trümmern"},
                {"SLOTS_MESP507", "Baue die Pyramiden!"}, {"SLOTS_MESN508", "Das Leben ist eine Wüste"},
                {"SLOTS_MESP508", "Erobert!"}, {"SLOTS_MESN509", "Grab vorbereitet!"},
                {"SLOTS_MESP509", "Reichtümer warten!"}, {"SLOTS_MESN510", "Das Leben nach dem Tod erwartet"},
                {"SLOTS_MESP510", "Wohlstand kommt!"}, {"SLOTS_MESN511", "Tot und begraben"},
                {"SLOTS_MESP511", "Heil dem neuen Pharao!"}, {"SLOTS_MESN512", "Sand bringt dich!"},
                {"SLOTS_MESP512", "Du bist der goldene Gott!"}, {"SLOTS_MESN513", "Dein Schicksal ist besiegelt"},
                {"SLOTS_MESP513", "Du bist eine Legende!"}, {"SLOTS_MESN514", "Dynastie in Trümmern!"},
                {"SLOTS_MESP514", "Katzen sind großartig!"}, {"SLOTS_MESN515", "Imperium zerstört!"},
                {"SLOTS_MESP515", "Prächtiger Herrscher!"}, {"SLOTS_MESN516", "Mumifiziert!"},
                {"SLOTS_MESP516", "Eine reiche Rückkehr!"}, {"SLOTS_MESN601", "Verschwendet"}, {"SLOTS_MESP601", "Nehmen Sie einen Stich"},
                {"SLOTS_MESN602", "Ermordet"}, {"SLOTS_MESP602", "Machen Sie einen Mord"},
                {"SLOTS_MESN603", "Was für ein Massaker"}, {"SLOTS_MESP603", "Töte es!"}, {"SLOTS_MESN604", "Niedergestochen"},
                {"SLOTS_MESP604", "Zeit, es zu töten!"}, {"SLOTS_MESN605", "Vernichtet!"}, {"SLOTS_MESP605", "Spielen!"},
                {"SLOTS_MESN606", "Tot"}, {"SLOTS_MESP606", "Bring es um!"}, {"SLOTS_MESN607", "Foulspiel!"},
                {"SLOTS_MESP607", "Zeit für Blut"}, {"SLOTS_MESN608", "Fertig!"}, {"SLOTS_MESP608", "Schlacht es!"},
                {"SLOTS_MESN609", "Gekocht!"}, {"SLOTS_MESP609", "Sei der Jäger!"}, {"SLOTS_MESN610", "Geschlachtet"},
                {"SLOTS_MESP610", "Baden Sie in Blut!"}, {"SLOTS_MESN611", "Was für ein Horror!"},
                {"SLOTS_MESP611", "Töte sie alle!"}, {"SLOTS_MESN612", "Zerstört"}, {"SLOTS_MESP612", "Keine Reue!"},
                {"SLOTS_MESN613", "Du bist das Opfer!"}, {"SLOTS_MESP613", "Erstes Blut abziehen!"},
                {"SLOTS_MESN614", "Gebraten"}, {"SLOTS_MESP614", "Mehr Leichensäcke!"}, {"SLOTS_MESN615", "Kein Entkommen!"},
                {"SLOTS_MESP615", "Du bist ein Cutter!"}, {"SLOTS_MESN616", "Ausgerottet!"},
                {"SLOTS_MESP616", "Chop, Chop!"}, {"SLOTS_MESN701", "Erwischt"}, {"SLOTS_MESP701", "Was für ein Tycoon!"},
                {"SLOTS_MESN702", "Broke!"}, {"SLOTS_MESP702", "Magnat!"}, {"SLOTS_MESN703", "Ouch!"},
                {"SLOTS_MESP703", "Go farmen!"}, {"SLOTS_MESN704", "Pleite!"}, {"SLOTS_MESP704", "Also wohlhabend!"},
                {"SLOTS_MESN705", "Chapter 11"}, {"SLOTS_MESP705", "Geladen!"}, {"SLOTS_MESN706", "Das tut weh!"},
                {"SLOTS_MESP706", "Dividenden!"}, {"SLOTS_MESN707", "Knapp bei Kasse!"}, {"SLOTS_MESP707", "Bling!"},
                {"SLOTS_MESN708", "Suppenlinie!"}, {"SLOTS_MESP708", "Unbezahlbar!"}, {"SLOTS_MESN709", "Urgh!"},
                {"SLOTS_MESP709", "Dahin rollen!"}, {"SLOTS_MESN710", "Du bist Niemand!"}, {"SLOTS_MESP710", "Easy!"},
                {"SLOTS_MESN711", "Wertlos"}, {"SLOTS_MESP711", "Einwandfreier Geschmack!"}, {"SLOTS_MESN712", "Ausgegeben!"},
                {"SLOTS_MESP712", "So extravagant!"}, {"SLOTS_MESN713", "Abgeprallt!"}, {"SLOTS_MESP713", "Geprägt!"},
                {"SLOTS_MESN714", "Ruiniert!"}, {"SLOTS_MESP714", "Fette Cat!"}, {"SLOTS_MESN715", "Mittellos!"},
                {"SLOTS_MESP715", "Hohe Klasse!"}, {"SLOTS_MESN716", "Faker!"}, {"SLOTS_MESP716", "Funkelnd!"},
                {"SLOTS_MESN801", "Gespült!"}, {"SLOTS_MESP801", "Du bist die Nummer eins!"},
                {"SLOTS_MESN802", "Du bist jetzt auf der C-Liste!"}, {"SLOTS_MESP802", "Die 80er-Regel!"},
                {"SLOTS_MESN803", "Vinewood Hasst dich!"}, {"SLOTS_MESP803", "Du hast den Krieg gewonnen!"},
                {"SLOTS_MESN804", "Die 80er sind vorbei!"}, {"SLOTS_MESP804", "Sei ein Action-Held!"},
                {"SLOTS_MESN805", "Ihre Karriere ist beendet!"}, {"SLOTS_MESP805", "America Liebt dich!"},
                {"SLOTS_MESN806", "Zeit für den Ruhestand"}, {"SLOTS_MESP806", "Feiern Sie es!"},
                {"SLOTS_MESN807", "Du wurdest vergessen!"}, {"SLOTS_MESP807", "Du bist unaufhaltsam!"},
                {"SLOTS_MESN808", "Eliminiert"}, {"SLOTS_MESP808", "Du bist der Größte!"}, {"SLOTS_MESN809", "Verschwendet"},
                {"SLOTS_MESP809", "Du bist der beste!"}, {"SLOTS_MESN810", "Fertig!"}, {"SLOTS_MESP810", "Es ist nie vorbei"},
                {"SLOTS_MESN811", "See Ya!"}, {"SLOTS_MESP811", "Sie haben Amerika gerettet!"},
