Config = {
    ...
    Text = {
        ...
        AIM_LEFT = "Ziele links",
        AIM_RIGHT = "Ziele Rechts",
        AIM_SLOWER = "Ziele Langasamer",

        POOL = 'Billiard',
        POOL_GAME = 'Pool Spiel',
        POOL_SUBMENU = 'Was willst du spielen?',
        TYPE_8_BALL = '8-ball',
        TYPE_STRAIGHT = 'Straight pool',

        HINT_SETUP = 'Tisch aufbauen',
        HINT_TAKE_CUE = 'Köe nehmen',
        HINT_RETURN_CUE = 'Köe zurückgeben',
        HINT_HINT_TAKE_CUE = 'Um Billiard zu spielen, nimm den Köe aus dem Ständer',
        HINT_PLAY = 'Spielen',

        BALL_IN_HAND_LEFT = 'Links',
        BALL_IN_HAND_RIGHT = 'Rechts',
        BALL_IN_HAND_UP = 'Oben',
        BALL_IN_HAND_DOWN = 'unten',
        BALL_POCKETED = '%s ball wurde versenkt',
        BALL_IN_HAND_NOTIFY = 'Der Spieler hat die weiße Kugel in der Hand',
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',
