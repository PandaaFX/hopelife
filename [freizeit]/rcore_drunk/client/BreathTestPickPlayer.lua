...
if Config.Framework ~= 0 then
    RegisterCommand("givetest", function()
        if IsPlayerAtJob(Config.WhitelistedJobsToTestBreath) then
            ...
            if enabledTag then
                ESX.ShowAdvancedNotification("Alkoholtest", "Officer", "Ziel mit links Klick auf den mit dem Wolf über dem Kopf, rechts Klick brichst du ab", "CHAR_CALL911", 1)
                ...
                ESX.ShowAdvancedNotification("Alkoholtest", "Officer", "You do not want to give the breath test anymore... Did he paid well at least?", "CHAR_CALL911", 1)
