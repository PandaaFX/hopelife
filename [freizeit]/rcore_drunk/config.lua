...
Config.DrunkList = {
    {
        ...
        eachSipGiveDrunk = 25, -- 2 * 5 = 10% drunk from one beer if he drink whole
        attachmentInfo = {
            boneId = 18905,
            objectHash = GetHashKey("prop_cs_beer_bot_01"),
    ...
    },
    {
        ...
        attachmentInfo = {
            boneId = 18905,
            objectHash = GetHashKey("prop_champ_flute"),
    ...
    },
    {
        ...
        attachmentInfo = {
            boneId = 18905,
            objectHash = GetHashKey("prop_whiskey_01"),
    ...
    },
    {
        ...
        attachmentInfo = {
            boneId = 18905,
            objectHash = GetHashKey("prop_cocktail"),
    ...
    },
    {
        ...
        attachmentInfo = {
            boneId = 18905,
            objectHash = GetHashKey("prop_beer_am"),
    ...
    },
    {
        ...
        attachmentInfo = {
            boneId = 18905,
            objectHash = GetHashKey("ng_proc_beerbottle_01a"),
