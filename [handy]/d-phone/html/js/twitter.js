...
$(document).on('click', '#ptw-pbsubmit', function () {
  ...
  if (
    ...
    if (
      ...
      $('.phone-twitter-settings-avatar').css(
        'background-image',
        'url(' + avatar + ')'
      );
      $('.phone-twitter-newpb').fadeOut(500);
...
$(document).on('click', '#ptw-usernamesubmit', function () {
  ...
  if (
    ...
    message1.includes('html') == true ||
    message1.includes('iframe') == true ||
    message1.includes('img') == true ||
    message1.includes('src') == true ||
    message1.includes('div') == true ||
    message1.includes('image') == true ||
    message1.includes('div') == true ||
    message1.includes('mp4') == true ||
    message1.includes('<') == true ||
    message1.includes('>') == true
...
$(document).on('click', '#ptw-ftavatarsubmit', function () {
  ...
  if (
    ...
    if (
      ...
      $('.phone-twitter-firsttime-avatar').css(
        'background-image',
        'url(' + avatar + ')'
      );
...
$(document).on('click', '#twitter-firsttimeregister', function () {
  ...
  if (
    ...
    if (
      message2.indexOf('script') > -1 ||
      message2.indexOf('http') > -1 ||
      message2.indexOf('www') > -1 ||
      message2.includes('<audio') == true ||
      message2.includes('</audio') == true
    ) {
      sendData('notification', { text: 'Nice try d:^)', length: 5000 });
    } else {
...
$(document).on('click', '.phone-tweet-footer-hearticon', function () {
  ...
  if (
    $(this).attr('class') ==
    'phone-tweet-footer-icons phone-tweet-footer-hearticon fas fa-heart liked'
  ) {
