...
const vornameinputsource = document.getElementById(
  'phone-app-contact-edit-name'
);
const vornameinput = document.getElementById('phone-app-edit-newcontact');

const nachnameinputsource = document.getElementById(
  'phone-app-contact-edit-lastname'
);
const nachnameinput = document.getElementById(
  'phone-app-edit-newlastnamecontact'
);
...
const contactsearchBar =
  document.forms['phone-app-contact-page-searchbar'].querySelector('input');
