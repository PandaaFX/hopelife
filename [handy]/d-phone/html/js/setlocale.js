        ...
        if (v.setlocale == true) {
          ...
          usedlocale = locale2
            if (locale2 == "en") {
                ...
                $(".locale_paragraph").each(function() {
                    $(this).html(locale.paragraph);
                });
                ...
                $("#phonesettingsselectionapptext ").html('<i class="fa-solid fa-underline"></i>&nbsp' + locale.showapptext);
            ...
            if ( locale2 == "de" ) {
                ...
                $("#phonesettingsselectionapptext ").html('<i class="fa-solid fa-underline"></i>&nbsp' + localede.showapptext);
