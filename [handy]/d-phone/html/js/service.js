...
$(document).on('click', '.phone-service-element', function () {
  ...
  if (number == label) {
    ...
    if ($('#service-page-call').hasClass('redcolor'))
      $('#service-page-call').removeClass('redcolor');
    if ($('#service-page-call').hasClass('purplecolor') == false)
      $('#service-page-call').addClass('purplecolor');
  }
