...
$(function() {
    ...
    window.addEventListener("message", function(event) {
        ...
        if (v.app == "groupchat" && v.task == "overview:load") {
            ...
            if (v.unread > 0) {
                $("#groupchat-alerts").show(0)
            } else {
                $("#groupchat-alerts").hide(0)
            }

            $("#groupchat-alerts").html(unreadhtml)
...
$('.groupchat-setting-element-2').sort(function(a, b) {
    ...
    $wrapper.find('.groupchat-setting-element-2').sort(function (a, b) {
...
$(document).on('click', '.groupchat-setting-element-2', function() {
