...
Config.Debug = false
Config.useBetaSync = false -- Enhances the sync, but this is still experimental
...
Config.useESXWeightSystem = true -- when you use item weights enable this
Config.useMyClothesAPI = true
...
-- typical ones: "money" or "cash" (depends on the ESX version), "bank" and "black_money"
Config.moneyAccount = 'bank' -- also 'bank' is possible, for all actions regarding money

Config.PayRent = {h= 12, m = 00} -- rents were paid at 20:00 -> 8 pm
...
Translation = {
    ['de'] = {
        ...
        ['outfit_delete'] = 'Das Outfit ~y~',
        ['outfit_delete2'] = ' ~s~wurde gelöscht.',
    },
    ...
    ['en'] = {
        ...
        ['outfit_delete'] = 'Outfit ~y~',
        ['outfit_delete2'] = ' ~s~was deleted.',
    }
