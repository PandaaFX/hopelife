...
function Properties:CreateProperty()
    if not Property.Pos then return ESX.ShowNotification("~r~Kein EIngang definiert.") end
    ...
    ESX.ShowNotification("Objekt erstellt ~b~" .. Property.Name .. "~s~\nMieter : ~b~" .. Property.Price .. "$")
        ...
        Menu = {
            ["Nouvelle propriété"] = {
                b = {
                    ...
                    { name = "Interior", slidemax = Properties.Interior:GetSlideMaxFromConfig()},
