...
Properties.Interiors = {
    ...
    { name = "High1",           label = "High",              price = 1250, enter = vector3(-1451.6394, -523.5562, 55.9290), chest = vector3(-1469.73,-545.54,55.53)},
