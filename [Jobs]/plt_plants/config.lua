...
PLT.Water = {dbName = "water", label = "Wasser"}                 -- The "name" and "label" of the water in "your framework".
PLT.Fertilizer = {dbName = "fertilizer", label = "Dünger"}  -- The "name" and "label" of the fertilizer in "your framework".
PLT.Burner = false                                              -- SET = (false or {dbName = "burner", label = "Burner", delete = true}), The "name" and "label" of the Burner in "your framework" if you set false it will not need item to burn.
...
PLT.Plants ={
    ["highgradefemaleseed"] = {
        ...
        timeToReadyForHarvest = 60 * 20 * 1,                        -- SET = (Second), How long should take for plant to be ready to harvest.
        ...
        startingPercentOfWater = {min=5,max=10},                      -- SET = (Number), Starting water percentage when the seed is planted, a random value between min and max.
        startingPercentOfFertilizer ={min=0,max=5},                -- SET = (Number), Starting fertilize percentage when the seed is planted, a random value between min and max.
        maxPlantForthisType = 50,                                     -- SET = (Number), The max limit of this type of plant for one person to sow.
        Harvest = {min=5,max=20},                                    -- SET = (Number), How many items should harvesting give according to it's quality.
        exportItem = "weed",                                    -- SET = ("ItemName"), What item will be given after harvesting.
        extraItem = false,                                     -- SET = ("ItemName" or false), Secondary item will be given after harvesting. (Could be seeds) No extra item will be given if set to "false"
        ...
        extraItemAmount= {min=1,max=5},                             -- SET = (number), How many extra items will be given.
    ...
    --[[["poppy_seed"] = {
        ...
        plantDirtProp = "bzzz_prop_seeds_001",                       -- SET = ("PropName" or false) if you use "bzzz_prop_seeds_001" a sludge appears under the plant. if you dont want set it false
        aWaterHowManyPercent = 30,                                   -- SET = (Number), How much percentage should one watering fill.
        aFertilizerHowManyPercent = 60,                              -- SET = (Number), How much percentage should one fertilizing fill.
        timeToReadyForHarvest = 60 * 60 * 10,                        -- SET = (Second), How long should take for plant to be ready to harvest.
        secWillFullWaterRunOut = 60 * 60 * 10,                       -- SET = (Second), How long untill water drops from 100% to 0%
        secWillFullFertilizerRunOut = 60 * 60 * 5,                   -- SET = (Second), How long untill fertilize drops from 100% to 0%
        secWillWaterComplateFullQualityFromZero = 60 * 60 * 10,      -- SET = (Second), Water adds quality to Plants. How long should water take to increase plant quality from 0% to 100%.
        secWillWaterWillDropZeroQualityFromFull = 60 * 60 * 5,       -- SET = (Second), Fertilizing adds quality to Plants. How long should fertilize take to increase plant quality from 0% to 100%.
        secWillFertilizerComplateFullQualityFromZero = 60 * 60 * 5,  -- SET = (Second), Lack of water decreases the plant quality. How long should it take to decrease plant quality from 100% to 0%.
        secWillFertilizerWillDropZeroQualityFromFull = 60 * 60 * 10, -- SET = (Second), Lack of fertilize decreases the plant quality. How long should it take to decrease plant quality from 100% to 0%.
        decayTime =  60 * 60 * 20,                                   -- SET = (Second or false), Plant will start to decay after it's ready to harvest. How long should it take to decay. If set "false" the plant won't decay.
        aliveWithoutWaterTime =  60 * 60 * 5,                        -- SET = (Second or false), When plant is growing, it will start to decay if it has no water. How long should it take to decay. If set "false" the plant won't decay from lack of water.
        startingPercentOfQuality ={min=40,max=60},                   -- SET = (Number), Starting quality when the seed is planted, a random value between min and max.
        ...
        Harvest = {min=2,max=10},                                    -- SET = (Number), How many items should harvesting give according to it's quality.
        ...
        extraItemChange = true,                                      -- SET = (Number / true or false), If set to number, extra item will be given as written number percentage chance. If set to "true" extra item will always be given. If set to "false" extra item will be given if only the quality of the plant is over 50%
        extraItemAmount= {min=10,max=20},                            -- SET = (number), How many extra items will be given.
        extraItemAmountAccordingToTheQuality = true,                 -- SET = (true or false), If "false" the number of extra item will be given is totally random between max and min numbers. If "true" it will be given according to quality of the plant.
        everyOneCanFire = true,                                      -- SET = (true or false), If "true" everyone can burn the plant. If "false" only the owner of the plant can burn it.
        OnlyOutOfCity = true,                                        -- SET = (true or false), If "true" the seeds can only be planted outside of the city.
        OutsideTheAreas ={                                                       -- If you set extra coordinates below, this seed won't be able to planted on those coordinates.
    ...
    ["tobacco_seed"] = {
        ...
        timeToReadyForHarvest = 60 * 60 * 15,                        -- SET = (Second), How long should take for plant to be ready to harvest.
        secWillFullWaterRunOut = 60 * 60 * 10,                       -- SET = (Second), How long untill water drops from 100% to 0%
        secWillFullFertilizerRunOut = 60 * 60 * 5,                   -- SET = (Second), How long untill fertilize drops from 100% to 0%
        secWillWaterComplateFullQualityFromZero = 60 * 60 * 20,      -- SET = (Second), Water adds quality to Plants. How long should water take to increase plant quality from 0% to 100%.
        secWillWaterWillDropZeroQualityFromFull = 60 * 60 * 5,       -- SET = (Second), Fertilizing adds quality to Plants. How long should fertilize take to increase plant quality from 0% to 100%.
        ...
        startingPercentOfFertilizer ={min=10,max=20},                -- SET = (Number), Starting fertilize percentage when the seed is planted, a random value between min and max.
        maxPlantForthisType = 2,                                     -- SET = (Number), The max limit of this type of plant for one person to sow.
        Harvest = {min=25,max=50},                                   -- SET = (Number), How many items should harvesting give according to it's quality.
    ...
    ["dragonfruit_seed"] ={
        ...
        startingPercentOfWater = {min=0,max=1},                      -- SET = (Number), Starting water percentage when the seed is planted, a random value between min and max.
        startingPercentOfFertilizer ={min=10,max=20},                -- SET = (Number), Starting fertilize percentage when the seed is planted, a random value between min and max.
        maxPlantForthisType = 1,                                     -- SET = (Number), The max limit of this type of plant for one person to sow.
    ...
    ["strawberry_seed"] ={
        ...
        aWaterHowManyPercent = 25,                                   -- SET = (Number), How much percentage should one watering fill.
        aFertilizerHowManyPercent = 50,                              -- SET = (Number), How much percentage should one fertilizing fill.
        timeToReadyForHarvest = 60 * 60 * 4,                         -- SET = (Second), How long should take for plant to be ready to harvest.
        secWillFullWaterRunOut = 60 * 60 * 2,                        -- SET = (Second), How long untill water drops from 100% to 0%
        secWillFullFertilizerRunOut = 60 * 60 * 1,                   -- SET = (Second), How long untill fertilize drops from 100% to 0%
        secWillWaterComplateFullQualityFromZero = 60 * 60 * 4,       -- SET = (Second), Water adds quality to Plants. How long should water take to increase plant quality from 0% to 100%.
        ...
        secWillFertilizerWillDropZeroQualityFromFull = 60 * 60 * 4,  -- SET = (Second), Lack of fertilize decreases the plant quality. How long should it take to decrease plant quality from 100% to 0%.
        decayTime =  60 * 60 * 8,                                    -- SET = (Second or false), Plant will start to decay after it's ready to harvest. How long should it take to decay. If set "false" the plant won't decay.
        aliveWithoutWaterTime =  false,                              -- SET = (Second or false), When plant is growing, it will start to decay if it has no water. How long should it take to decay. If set "false" the plant won't decay from lack of water.
        startingPercentOfQuality ={min=40,max=60},                   -- SET = (Number), Starting quality when the seed is planted, a random value between min and max.
        ...
        maxPlantForthisType = 2,                                     -- SET = (Number), The max limit of this type of plant for one person to sow.
        Harvest = {min=1,max=10},                                    -- SET = (Number), How many items should harvesting give according to it's quality.
    ...
    ["mushroom_seed"] ={
        ...
        plantDirtProp = "bzzz_prop_seeds_001",                        -- SET = ("PropName" or false) if you use "bzzz_prop_seeds_001" a sludge appears under the plant. if you dont want set it false
        aWaterHowManyPercent = 50,                                    -- SET = (Number), How much percentage should one watering fill.
        aFertilizerHowManyPercent = 100,                              -- SET = (Number), How much percentage should one fertilizing fill.
        timeToReadyForHarvest = 60 * 60 * 1,                          -- SET = (Second), How long should take for plant to be ready to harvest.
        secWillFullWaterRunOut = 60 * 30 * 1,                         -- SET = (Second), How long untill water drops from 100% to 0%
        secWillFullFertilizerRunOut = 60 * 15 * 1,                    -- SET = (Second), How long untill fertilize drops from 100% to 0%
        ...
        secWillWaterWillDropZeroQualityFromFull = 60 * 15 * 1,        -- SET = (Second), Fertilizing adds quality to Plants. How long should fertilize take to increase plant quality from 0% to 100%.
        secWillFertilizerComplateFullQualityFromZero = 60 * 15 * 1,   -- SET = (Second), Lack of water decreases the plant quality. How long should it take to decrease plant quality from 100% to 0%.
        ...
        aliveWithoutWaterTime =  60 * 30 * 1,                         -- SET = (Second or false), When plant is growing, it will start to decay if it has no water. How long should it take to decay. If set "false" the plant won't decay from lack of water.
        startingPercentOfQuality ={min=50,max=100},                   -- SET = (Number), Starting quality when the seed is planted, a random value between min and max.
        ...
        startingPercentOfFertilizer ={min=0,max=0},                   -- SET = (Number), Starting fertilize percentage when the seed is planted, a random value between min and max.
        maxPlantForthisType = 5,                                      -- SET = (Number), The max limit of this type of plant for one person to sow.
        ...
        extraItemAmountAccordingToTheQuality = false,                 -- SET = (true or false), If "false" the number of extra item will be given is totally random between max and min numbers. If "true" it will be given according to quality of the plant.
        everyOneCanFire = false,                                      -- SET = (true or false), If "true" everyone can burn the plant. If "false" only the owner of the plant can burn it.
        OnlyOutOfCity = false,                                        -- SET = (true or false), If "true" the seeds can only be planted outside of the city.
        OutsideTheAreas ={                                                       -- If you set extra coordinates below, this seed won't be able to planted on those coordinates.
        --{coord = vector3(4666.0,-5100.0,15.0), distance = 1400},               -- For example; If you activate this line this seed can't be planted on island of Cayo Perico.
        --{coord = vector3(0.0,0.0,0.0), distance =  250},                       -- You can add as many coordinates as you like.
        --notify = "You cannot plant this plant on the island of Cayo Perico."   -- This is the error notify when someone tries to plant on this coordinates.
