...
Translation = {
    ['de'] = {
        ['used_clip'] = 'Du hast ~y~1x~s~ verwendet: ~y~',
        ['used_attachment'] = 'Du hast ~y~1x~s~ ~b~Komponente~s~ an der Waffe angebracht: ~y~',
        ['added_tint'] = 'Du hast deine Waffe gefärbt in Farbe ',
        ['used_attachment_remover'] = 'Du hast eine Waffenkomponente entfernt: ',
        ...
        -- Progress Bar
        ['reload_anim'] = 'Lade Waffe nach...',
    },
    ['en'] = {
        ['used_clip'] = 'You have used ~y~1x~s~ ',
        ['used_attachment'] = 'You have used ~y~1x~s~ ',
        ['added_tint'] = 'You have colored your Weapon with color ',
        ['used_attachment_remover'] = 'You removed a Weaponcomponent: ',
        ...
        -- Progress Bar
        ['reload_anim'] = 'Reloading Weapon...',
    },
    ['pl'] = {

        ['used_clip'] = 'Użyłeś  1x Magazynek.',
        ['used_attachment'] = 'Użyłeś 1x Części.',
        ['added_tint'] = 'Pokolorowałeś swoją Broń.',
        ['used_attachment_remover'] = 'Usunąłeś 1x  %s.',
    ...
    -- Progress Bar
        ['reload_anim'] = 'Przeładowanie broni...',
