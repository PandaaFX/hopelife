...
Config.Webhooks = {
    ['society_police'] = GetConvar("webhook_example", "Failed to load webhook error!"),
    ['society_ambulance'] = GetConvar("webhook_example", "Failed to load webhook error!"),
    ['society_lssd'] = GetConvar("webhook_example", "Failed to load webhook error!"),
    ['society_fib'] = GetConvar("webhook_example", "Failed to load webhook error!"),
    ['society_bauamt'] = GetConvar("webhook_example", "Failed to load webhook error!"),
    ['society_mechanic'] = GetConvar("webhook_example", "Failed to load webhook error!"),
