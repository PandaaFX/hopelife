...
function requestPlayerBills(_source)
...
function payBill(bill_type, invoiceID, target_type, target, amount, sender, _source)
    ...
    if hasEnoughMoney then
        ...
        TriggerClientEvent('myBills:msg', _source, Translation[Config.Locale]['not_enough_money'])
    end

end


function sendBill(playerId, sharedAccountName, label, amount, _source)
    local xPlayer = ESX.GetPlayerFromId(_source)
    local xPlayers = ESX.GetPlayers()
