-- Servus dumpkiddie, haste die Config gefunden?

RC = {}

RC.client_enableScreenshots = true 
RC.discord_screenshot_storage = "https://discord.com/api/webhooks/1027585268691251290/yf8vmMkL_lfWjU7-PWnVljtYazCRmXqQw1sGH27P142ViJZ9MrWsh-50K6wYQZKygY3y"
RC.client_blacklistedkeys = {"tab","insert","f2","delete","home","f12"}

RC.resourcechecker = true
RC.client_cacheDetection = true

RC.antispectate = true
RC.blockFreeCam = false
RC.antiblips = false

RC.autoAdminAuth = true
RC.adminMenuOpenKey = "insert"
RC.adminNoclipKey = "f11"

RC.client_checkWeapons = true
RC.client_blockWeaponPickups = true
