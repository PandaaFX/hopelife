...
DP.Shared = {
   ...
   ["kiss3"] = {"hs3_ext-20", "cs_lestercrest_3_dual-20", "Kiss 3", "kiss3", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 7500,
       SyncOffsetFront = 0.13
   }},
   ["kiss4"] = {"hs3_ext-20", "csb_georginacheng_dual-20", "Kiss 4", "kiss4", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 7500,
       SyncOffsetFront = 0.13
...
DP.Dances = {
   ...
   ["sittingpose"] = {"sitting1@blackqueen", "sitting1_clip", "Sitting Pose", AnimationOptions =
   {
      EmoteLoop = true
   }},
   ["sittingpose2"] = {"sitoncar1@blackqueen", "sitoncar1_clip", "Sitting Pose2", AnimationOptions =
   {
      EmoteLoop = true
   }},
   ...
   ["electroshuffle"] = {"custom@electroshuffle", "electroshuffle", "Electro Shuffle", AnimationOptions =
   {
      EmoteMoving = false,
      EmoteLoop = true,
   }},
...
DP.Emotes = {
   ...
   ["sexysit"] = {"sitsexylean@queensisters", "sitsexy_clip", "Sexy Sit", AnimationOptions =
   {
      EmoteLoop = true,
      EmoteMoving = true,
   }},
   ["sexylean"] = {"walllean2@queensisters", "walllean2_clip", "Sexy Lean", AnimationOptions =
   {
      EmoteLoop = true,
      EmoteMoving = true,
   }},
   ["sexycustom"] = {"posecustom@queensisters", "posecustom_clip", "Sexy Custom", AnimationOptions =
   {
      EmoteLoop = true,
      EmoteMoving = true,
   }},
   ["sexypose"] = {"hotpose@queensisters", "hotpose_clip", "Sexy Pose", AnimationOptions =
   {
      EmoteLoop = true,
      EmoteMoving = true,
   }},
   ["sexyknee"] = {"sitdownonknees@queensisters", "sitdown_clip", "Knien", AnimationOptions =
   {
      EmoteLoop = true,
      EmoteMoving = true,
   }},
...
DP.PropEmotes = {
   ...
   ["baseball"] = {"baseball@blackqueen", "baseball_clip", "Baseball", AnimationOptions =
   {
      EmoteLoop = true,
      EmoteMoving = true,
   }},
  ...
  ["ekg"] = {"move_weapon@jerrycan@generic", "idle", "EKG", AnimationOptions =
   {
      Prop = "prop_ld_bingbag_03",
      PropBone = 57005,
      PropPlacement = {0.3900,-0.0600, -0.0600, -100.00, -180.00, -78.00},
      EmoteLoop = true,
      EmoteMoving = true,
