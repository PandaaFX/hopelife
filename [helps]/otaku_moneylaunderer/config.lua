...
Config.baseRate = 95 -- The minimum launder rate (50% means for every $2 dirty, you get $1 clean)
Config.bonusPerCop = 5 -- Increase the launder rate by this percentage for each online cop
Config.maxRate = 0.9 -- This is the maximum laundering rate, default 0.8 means the maximum is 80%
Config.minStack = 1000 -- The minimum amount of clean money laundered in one transaction
Config.maxStack = 25000 -- The maximum amount of clean money laundered in one transaction

Config.launderSpeed = 2000 -- How quickly money is laundered in ms (2500 is 2.5s)
Config.versionCheck = true -- On script startup, should we check for updates?

Config.callPoliceChance = 100 -- The higher this number, the less likely a CAD is sent to the police
