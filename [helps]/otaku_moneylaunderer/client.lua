...
function isEmergencyStaff()
    if ESX.PlayerData.job ~= nil and (ESX.PlayerData.job.name == "police" or ESX.PlayerData.job.name == "ambulance" or ESX.PlayerData.job.name == "offpolice" or ESX.PlayerData.job.name == "offambulance") then
        return true
    else
        return false
    end
    ...
    function()
        ...
        while true do
            ...
            if isNearMoneyLaunderer() <= 5.0 and not IsPedInAnyVehicle(ply) and laundering == -1 then
                dirtyWaitTime = 0
                drawTxt("Drücke ~g~E~s~ um dein Geld zu waschen", 0, 1, 0.5, 0.8, 0.6, 255, 255, 255, 255)
                ...
                if IsControlJustPressed(1, 38) then
                    ...
                    ESX.ShowAdvancedNotification(
                        "Geldwäsche",
                        "Info",
                        "Gib mir Zeit, ich muss das Geld erst überprüfen",
                        "CHAR_HUMANDEFAULT"
                    )
                    ...
                    if isNearSpecificMoneyLaunderer(lastSpot) and not IsPedInAnyVehicle(ply) then
                        ...
                        ESX.ShowAdvancedNotification("Money Laundering", "NPC:", "Hey, wohin willst du ?", "blue")
                    end
                end
            end
        end
    ...
    function(launderer)
        if launderer ~= currentLaunderer then
            ...
            if not isEmergencyStaff() then
                ...
                AddTextComponentString("Geldwäsche")
        ...
        if launderNPC ~= nil then
            ...
            elseif reaction == 2 then
                ...
                TriggerEvent(
                    ...
                    "~g~*Launderer* ~w~ Ah Scheiße, ich muss los.. Ich versteck die Kohle, ich kann nicht wieder in den Knast",
                    25
                )
