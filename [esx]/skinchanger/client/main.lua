local Components = {
	...
	{label = _U('decals_1'),				name = 'decals_1',			value = -1,		min = -1,	zoomOffset = 0.75,		camOffset = 0.15,	componentId	= 10},
	{label = _U('decals_2'),				name = 'decals_2',			value = -1,		min = -1,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'decals_1'},
	...
	{label = _U('glasses_1'),				name = 'glasses_1',			value = -1,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,	componentId	= 1},
