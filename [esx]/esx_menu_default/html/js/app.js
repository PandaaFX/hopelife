(function(){
	...
	let MenuTpl =
		...
		// '<img src="https://i.imgur.com/vcr3S9R.png" alt="testus" />' +
	...
	ESX_MENU.open = function(namespace, name, data) {
		...
		ESX_MENU.render();
		$('#menu_' + namespace + '_' + name).find('.menu-item.selected'); --$('#menu_' + namespace + '_' + name).find('.menu-item.selected')[0].scrollIntoView();
	};
