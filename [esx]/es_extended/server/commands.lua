ESX.RegisterCommand('setcoords', {'admin', 'dev'}, function(xPlayer, args, showError)
	-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:setcoords"}
...
ESX.RegisterCommand('setjob', {'admin', 'dev'}, function(xPlayer, args, showError)
	-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:setjob"}
...
ESX.RegisterCommand('car', {'admin', 'dev', 'cardev1','cardev2'}, function(xPlayer, args, showError)
	if not args.car then args.car = "Prototipo" end
	xPlayer.triggerEvent('esx:spawnVehicle', args.car)
	-- exports.logmanager:log{player = xPlayer.source, message = "esx:spawnVehicle"}
end, false, {help = _U('command_car'), validate = false, arguments = {
	{name = 'car', help = _U('command_car_car'), type = 'any'}
}})

ESX.RegisterCommand({'cardel', 'dv'}, {'admin', 'dev', 'mod','support', 'cardev1','cardev2'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setaccountmoney', 'admin', function(xPlayer, args, showError)
	-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:setaccountmoney"}
...
ESX.RegisterCommand('giveaccountmoney', {'admin', 'dev'}, function(xPlayer, args, showError)
	-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:giveaccountmoney"}
	if args.playerId.getAccount(args.account) then
...
if not Config.OxInventory then
	ESX.RegisterCommand('giveitem', {'admin', 'dev'}, function(xPlayer, args, showError)
		-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:giveitem"}
	...
	ESX.RegisterCommand('giveweapon', 'admin', function(xPlayer, args, showError)
		-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:giveweapon"}
	...
	ESX.RegisterCommand('giveweaponcomponent', 'admin', function(xPlayer, args, showError)
		-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:giveweaponcomponent"}
...
if not Config.OxInventory then
	ESX.RegisterCommand('clearinventory', {'admin', 'dev'}, function(xPlayer, args, showError)
		-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:clearinventory"}
	...
	ESX.RegisterCommand('clearloadout', {'admin', 'dev'}, function(xPlayer, args, showError)
		-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:clearloadout"}
...
ESX.RegisterCommand('setgroup', {'admin', 'dev'}, function(xPlayer, args, showError)
	-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:setgroup"}
...
ESX.RegisterCommand('coords', {'admin', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('goto', {'admin', 'dev', 'mod', 'support','cardev1'}, function(xPlayer, args, showError)
	-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:goto"}
...
ESX.RegisterCommand('bring', {'admin', 'dev', 'mod', 'support','cardev1'}, function(xPlayer, args, showError)
	-- exports.logmanager:log{player = xPlayer.source, message = "es_extended:bring"}
...
ESX.RegisterCommand('kill', {'admin', 'dev'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent("esx:killPlayer")
	-- exports.logmanager:log{player = xPlayer.source, message = "esx:killPlayer"}
end, true, {help = _U('kill'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('freeze', {'admin', 'dev'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "freeze")
	-- exports.logmanager:log{player = xPlayer.source, message = "esx:freezePlayer"}
end, true, {help = _U('kill'), validate = true, arguments = {
{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('unfreeze', {'admin', 'dev'}, function(xPlayer, args, showError)
...
-- ESX.RegisterCommand('players', {'admin', 'dev', 'mod','support','cardev1'}, function(xPlayer, args, showError)
