...
Config.TimetoFlip = 15						-- How long, in seconds, to flip the car.
...
Config.Lang = {
	['flipped'] = 'Fahrzeug gedrehte!',
    ['in_vehicle'] = 'Das kannst du nicht aus dem Innenraum!',
    ['far_away'] = 'Nicht nah genug am Fahrzeug!',
    ['not_allowed'] = 'Du hast nicht das Werkzeug oder Erfahrung, das Fahrzeug zu drehen!',
}
