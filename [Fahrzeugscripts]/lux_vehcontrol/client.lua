			...
			if IsPedInAnyVehicle(playerped, false) then	
				...
				if GetPedInVehicleSeat(veh, -1) == playerped then
					...
					if GetVehicleClass(veh) == 18 then
						...
						DisableControlAction(0, 58, true) -- INPUT_CHARACTER_WHEEL 
						DisableControlAction(0, 306, true) -- INPUT_VEH_RADIO_WHEEL 
						...
						if not IsPauseMenuActive() then
							...
							-- TOG LX SIREN
							elseif IsDisabledControlJustReleased(0, 58) then
