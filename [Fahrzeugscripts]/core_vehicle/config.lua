...
EngineRepairTime = 1 * 60 * 1000, 
EngineInstallTime = 3 * 60 * 1000,

TurboRepairTime = 1 * 60 * 1000, 
TurboInstallTime = 3* 60 * 1000,

NitroInstallTime = 1 * 60 * 1000,

OilInstallTime = 1 * 60 * 1000,

TransmissionRepairTime = 1 * 60 * 1000,
TransmissionInstallTime = 3 * 60 * 1000,

TireRepairTime = 1 * 60 * 1000,
TireInstallTime = 3 * 60 * 1000,

BreaksRepairTime = 1 * 60 * 1000,
BreaksInstallTime = 3 * 60 * 1000,

SuspensionRepairTime = 1 * 60 * 1000,
SuspensionInstallTime = 3 * 60 * 1000,

SparkPlugsRepairTime = 1 * 60 * 1000,
SparkPlugsInstallTime = 3 * 60 * 1000,
...
MechanicWorkshop = { -- Mechanic Workshops where mechanics can use MechanicWorkshopAccess
    {coords = vector3(123.87, -3047.393, 7.038), radius = 20.0}
},
...
Nitros = { -- Nitro affect vehicle power and increases vehicle wear during usage
    ...
    ['nos'] = {
        ...
        usability = {exclusive = {}, vehicletypes = {}},
        power = 100.0,
        durability = 12.0 -- Here enter seconds until nitro will run out
    }
...
['race_transmission_4wd'] = {
    ...
    durability = 50.0,
    manual = { [6] = {3.33, 1.95, 1.39, 1.09, 0.95, 0.90}  }, -- (ADVANCED ONLY!) You can define each gear's ratio. Example is only for vehicles with max 6 gears
    repair = {
            ['iron'] = {amount = 5, label = "Iron", reusable = false}
        }
},
