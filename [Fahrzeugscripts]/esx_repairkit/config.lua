...
Config.DestroyChance				= 3			-- The lower it is, the more it has a chance to destroy the engine. (1 = 100%, 2 = 50%, 4 = 25%, 10 = 10%, 100 = 1%, etc)
...
Config.MechanicNameJob              = 'mechanic'  -- If your mechanic job is not named "mecano", you can change it here
