...
Config.gas_station_locations = {
	["gas_station_1"] = {										-- ID
		['buy_price'] = 3000000,									-- Price to buy this gas station
		['sell_price'] = 2000000,								-- Price to sell this gas station
	...
	["gas_station_19"] = {
		['buy_price'] = 3000000,
		['sell_price'] = 2000000,
		['coord'] = {162.0,6636.48,31.55,136.48},
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		...
		['ressuply_deliveryman'] = {					-- Driver contracts
			...
			['price_per_liter'] = 10					-- Standard price per contract liter
		},
		['ressuply'] = {								-- Definition of contracts for the owner
			[1] = {
				['name'] = 'Small cargo',				-- Name in contract
				['price_per_liter_to_import'] = 15,		-- Price per liter to import
				['price_per_liter_to_export'] = 15,		-- Price per liter to export
