...
---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "char_unicorn", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "char_unicorn", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
