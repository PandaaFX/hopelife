...
Config.RefuelWithJerryCanCost = 0
...
Config.DisableKeys = {0, 22, 23, 24, 29, 30, 31, 37, 44, 56, 82, 140, 166, 167, 168, 170, 288, 289, 311, 322, 323}
...
Config.Strings = {
	...
	EToRefuelJerryCan = "Drücke ~g~E ~w~um Fahrzeug zu betanken für ~g~$",
	EToRefuel = "Drücke ~g~E ~w~um dein Fahrzeug zu betanken",
	JerryCanEmpty = "Kanister ist Leer",
	FullTank = "Tank ist Voll",
	CancelFuelingJerryCan = "Drücke ~g~E ~w~ um abzubrechen",
	PurchaseJerryCan = "Drücke ~g~E ~w~um ein Kanister zu kaufen für ~g~$" .. Config.JerryCanCost,
	EToRefillJerryCan = "Drücke ~g~E ~w~um deinen Kanister aufzufüllen für ~g~$" .. Config.RefillCost,
...
Config.GasStations = {
	...
	vector3(-981.534058, -3018.909912, 13.929688),
	vector3(1703.129639, 3269.050537, 41.142090)
}
