...
Config.MiniGameOptions = {
    ...
    Difficulty = {
        Custom = {
            Zone = 10,         -- The percentage of the dial that is the trigger zone (lower = harder)
            Duration = 250    -- Time in milliseconds for the dial to fill in one direction (lower = harder)
        },
        Easy = {
            Zone = 30,
            Duration = 500
