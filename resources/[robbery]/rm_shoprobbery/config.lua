...
Config['ShopRobbery'] = {
    ...
    ['rewardMoneys'] = {
        ['safecrack'] = function()
            return math.random(70000, 85000) -- For safecrack money reward
        end,
        ['till'] = function() -- For till money reward
            return math.random(7000, 8500)
        end,
    },
    ['tillGrabTime'] = 180000, -- For grab till time (miliseconds)
    ['clerkWeaponChance'] = 35, -- Chance that the clerk will get scared or pull a gun
...
Strings = {
    ['grab_till'] = 'Drücke ~INPUT_CONTEXT~ um die Kasse auszuräumen',
    ['safecrack'] = 'Drücke ~INPUT_CONTEXT~ den Safe zu Knacken',
    ['pickup'] = 'Drücke ~INPUT_CONTEXT~ Inhalt ausräumen',
    ['wait_nextrob'] = 'Du musst noch warten um das wieder machen zu können',
    ['minute'] = 'Minuten.',
    ['need_this'] = 'Du brauchst das: ',
    ['need_police'] = 'Nicht genug Staatsfraktionen im Dienst.',
    ['total_money'] = 'Du bekommst das: ',
    ['police_alert'] = 'Shop Alarm! Schau auf dein GPS.',
    ['not_cop'] = 'Du bist kein Cop!',
    ['not_near'] = 'Kein Shop in der Nähe',
    ['safecrack_help'] = '~INPUT_FRONTEND_LEFT~ ~INPUT_FRONTEND_RIGHT~ Drehen\n~INPUT_FRONTEND_RDOWN~ Prüfen',
    ['charmoso_log_title'] = 'Geld Gestohlen',
    ['charmoso_store_being_robbed'] = 'Dein Shop wurde ausgeraubt!',
    ['charmoso_no_owner_online'] = 'Geschlossen!',
}
