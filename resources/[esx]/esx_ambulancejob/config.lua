...
Config.EarlyRespawnTimer          = 90000 * 10  -- time til respawn is available
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(-660.23, 318.74, 140.15),
			sprite = 61,
			scale  = 0.7,
			color  = 2
		},
...
GlobalState.Timer = 15 -- minutes for bleeding out

GlobalState.RespawnCoords = vector3(340.773621, -1396.734009, 32.498169) -- where the player will spawn after timer is at 0
GlobalState.RespawnHeading = 48.188972 -- heading for respawncoords