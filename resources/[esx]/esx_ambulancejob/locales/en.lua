Locales['en'] = {
  ...
  -- Death
  ['respawn_available_in'] = 'Notsanitäter verfügbar in: ~b~%s Minuten %s Sekunden~s~',
  ['respawn_bleedout_in'] = 'Du blutest aus in: ~b~%s Minuten %s Sekunden~s~\n',
  ['respawn_bleedout_prompt'] = 'Halte [~b~E~s~] um am MD zu Spawnen',
  ['respawn_bleedout_fine'] = 'Halte [~b~E~s~] für Notfallbehandlung. Kosten: ~g~$%s~s~',
  ['respawn_bleedout_fine_msg'] = 'Du zahlst ~r~$%s~s~ für die Behandlung.',
  ['distress_send'] = 'Drücke [~b~G~s~] um ein Notsignal zu senden',
  ['distress_sent'] = 'Notfall-SMS wurde an verfügbare Mediziner gesendet!',
  -- Revive
