...
Citizen.CreateThread(function()
    while true do
        --Buttons
	    SetDiscordRichPresenceAction(0, "Discord", "https://discord.gg/hopelife")
	    SetDiscordRichPresenceAction(1, "FiveM", "fivem://connect/193.42.12.47:30120")
        SetDiscordAppId(977372869686362122)                 --Discord App-ID
        SetDiscordRichPresenceAsset('big')             --Logo Name
        SetDiscordRichPresenceAssetText('HopeLife Roleplay')         --Logo Tooltip
        SetDiscordRichPresenceAssetSmall('big')     --Icon Name
        SetDiscordRichPresenceAssetSmallText('HopeLife Roleplay') --Icon Tooltip
        SetRichPresence(GetPlayerName (PlayerId()) .. " - ".. #GetActivePlayers() .. " Spieler in seiner Umgebung")
