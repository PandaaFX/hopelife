Config = {
    ...
    RechargeCoords = { -- Coordinated to recharge the pepper spray and decontamination spray
        vector3(13.516484, -1106.004395, 29.785400),
...
Config.Languages = {
    ['en'] = {
        ['quantity'] = 'Du hast ~b~{s}ml',
        ['split'] = 'Zum Sprühen drücke '..Config.Keys.SplitKeyString,
        ['rubbing'] = 'Augen reiben, drücke '..Config.Keys.RubbingKeyString,
        ['replacepepperspray'] = ' '..Config.Keys.ReplaceKeyString,
        ['replacedecontamination'] = 'Ersetze deinen Pfefferspray, Drücke '..Config.Keys.ReplaceKeyString
    },
    ['fr'] = {
