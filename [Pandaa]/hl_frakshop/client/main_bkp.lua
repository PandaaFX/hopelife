		...
		if hasEnoughMoney then
			...
			for i = 1, #Config.Shops, 1 do
				...
				if dist <= Config.InteractDistance then
					...
					DoScreenFadeIn(800)
					TriggerEvent('esx:showAdvancedNotification', 'Fraktions Autohändler', 'Information', "Du befindest dich zu weit weg vom Käufer.\nStelle dich näher dran und versuche es erneut.", 'CHAR_TOM', 1)
				end
