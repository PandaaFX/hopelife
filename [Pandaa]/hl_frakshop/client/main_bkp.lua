...
RegisterNUICallback('buy', function(data, cb)
    ESX.TriggerServerCallback('hl_frakshop:buyVehicle', function(hasEnoughMoney)
        if hasEnoughMoney then
            ...
            ESX.Game.SpawnVehicle(data.model, Config.SpawnZone, Config.SpawnHeading, function(vehicle)
                ...
                TriggerServerEvent('hl_frakshop:setVehicleOwned', vehicleProps, PlayerData.job.name)
                Citizen.Wait(500)
                DoScreenFadeIn(800)
                Citizen.Wait(700)
