		...
		if not mainMenu or not mainMenu:Visible() then
			...
			if strings and isAdmin then
				...
				if permissions["player.ban.temporary"] then
					table.insert(banLength, {label = "3 "..GetLocalisedText("hours"), time = 10800})
					...
					table.insert(banLength, {label = "2 "..GetLocalisedText("days"), time = 172800})
					table.insert(banLength, {label = "3 "..GetLocalisedText("days"), time = 259200})
					table.insert(banLength, {label = "4 "..GetLocalisedText("days"), time = 345600})
					table.insert(banLength, {label = "5 "..GetLocalisedText("days"), time = 432000})
					table.insert(banLength, {label = "6 "..GetLocalisedText("days"), time = 518400})--
